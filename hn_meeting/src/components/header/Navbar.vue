<template>
  <div class="navbar-wrapper clearfix">
    ...
    <div class="header-right">
      <!--<el-tooltip class="" v-if="!fullscreen" effect="dark" content="看板" placement="bottom">-->
        <!--<a class="func-wrapper font" target="_blank" href="/dashboard"><i class="fa fa-area-chart func-icon"></i></a>-->
        <!--&lt;!&ndash;<span class="func-wrapper font" @click="go2board"><i class="fa fa-area-chart func-icon"></i></span>&ndash;&gt;-->
      <!--</el-tooltip>-->
      ...
      <el-dropdown @command="handleCommand">
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item command="changepwd">
            <i aria-hidden="true" class="fa d2-mr-5 fa-lock"></i>&nbsp;修改密码
          </el-dropdown-item>
          <el-dropdown-item command="changelog">
            <i aria-hidden="true" class="fa d2-mr-5 fa-file-text-o"></i>&nbsp;更新日志
          </el-dropdown-item>
          <el-dropdown-item command="logout">
            <i aria-hidden="true" class="fa d2-mr-5 fa-power-off"></i>&nbsp;注销
          </el-dropdown-item>
          <el-dropdown-item command="">
            <i aria-hidden="true" class="fa d2-mr-5 fa-vimeo-square"></i>&nbsp;{{version}}
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
    </div>
