<template>
  ...
  <treeselect v-else-if="type === 'treeselect'"
              :disabled="disabled"
              :value="getTreeValue(value)"
              :placeholder="placeholder"
              :multiple="multiple"
              :options="options"
              @close="treeselectClose"
              @input="treeselectChange"/>
  <!--<el-select v-else-if="type === 'treeselect'"-->
             <!--ref="tree"-->
             <!--:value="getSelectValue(value)"-->
             <!--:size="size"-->
             <!--:clearable="clearable"-->
             ...
             <!--:multiple="multiple"-->
             <!--:placeholder="placeholder">-->
    <!--<el-option class="tree-select" :value="getTreeValAndLabel.value" :label="getTreeValAndLabel.label">-->
      <!--<el-tree :data="options" @node-click="treeNodeClick"></el-tree>-->
    <!--</el-option>-->
  <!--</el-select>-->
  <el-input v-else
            :type="type"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      getTreeValAndLabel() {  //  下拉框配合tree 组成的 下拉树形框
        if (this.type === 'treeselect') {
          let node = helper.getTreeNode(this.options, this.value, 'children')
          return {
            label: node.label,
            value: node.id
          }
    ...
    watch: {
      'value'() {
        ...
        if (this.appendicon) {  // <--- 高级搜索的时候，赋值的时候 强行触发change时间
