  ...
  <div class="search-wrapper">
    ...
    <transition name="show">
      <div class="search-form-wrapper" v-show="searchform.show">
        <el-form class="clearfix" ref="form" label-width="80px">
          <el-col class="format-height" :sm="8" v-for="(data, index) in forminfo" :key="index">
        ...
        <el-button class="button" @click="reset" size="mini">清空</el-button>
      </div>
    </transition>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      func(val, action = 'open') {
        this.formfunctions(val, action, this)
      },
      toggleSearch() {
