  ...
  <div class="edit-form">
    <el-popover
      ...
      <el-checkbox-group v-model="checkedFields" @change="handleCheckedFieldChange">
        <el-checkbox class="checkbox" v-for="field in fieldList" :label="field.value" :key="field.value">{{field.label}}</el-checkbox>
      </el-checkbox-group>
  ...
  export default {
    ...
    data() {
      return {
        show: false,
        checkAll: true,
        checkedFields: this.fieldList.map(f => f.value),
        isIndeterminate: false
      }
    },
    methods: {
      handleCheckAllChange(val) {
        this.checkedFields = val ? this.fieldList.map(f => f.value) : []
    ...
    watch: {
      'fieldList'() {
        this.isIndeterminate = false
        this.checkAll = true
        this.checkedFields = this.fieldList.map(f => f.value)
      }
    }
  }
</script>
