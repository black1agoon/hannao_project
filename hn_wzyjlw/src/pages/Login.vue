      ...
      <div class="form-group">
        <el-card>
          <el-form ref="loginForm" label-position="top" :rules="rules" :model="formLogin">
            ...
            <el-button ref="submit" @click="submit" type="primary" class="button-login" :loading="loading">登录
            </el-button>
          </el-form>
        </el-card>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      loginSuccess(data, systype) {
        ...
        this.$store.commit('SET_SYSTYPE', systype)
        if (window.localStorage) {
          window.localStorage.setItem('token', token)
          window.localStorage.setItem('menus', JSON.stringify(menus))
          window.localStorage.setItem('systype', systype)
        }
