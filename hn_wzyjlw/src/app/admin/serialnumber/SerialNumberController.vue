<template>
  <eui-layout :regions="REGIONS">
    ...
    <eui-table
      ...
      <el-table-column label="公司识别码" width="80" prop="compIdentifyCode">
      </el-table-column>
      <el-table-column label="创建时间" minWidth="150" prop="createTime">
      </el-table-column>
    ...
    <eui-window ref="window"
      ...
      <el-form class="clearfix" ref="form" :model="formdata" label-width="130px" :rules="rules" style="padding: 20px">
      ...
      return {
        ...
        tableOptions: {
          ...
          columns: [
            ...
            {prop: 'serialCurrentNum', label: '当前数值', width: 80},
            {prop: 'serialNumFormat', label: '序列号位数', width: 80},
            {prop: 'dateFormat', label: '日期格式', width: 80}
          ],
