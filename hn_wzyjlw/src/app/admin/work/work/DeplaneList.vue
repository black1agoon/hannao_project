...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      saveCellEdit() {
        api.workshopOrderDeplane.update({
      ...
      saveColumnEdit() {
        if (this.editId) {
          api.workshopOrderDeplane.updateSize({
            name: this.editValue,
            id: this.editId
          }).then(() => {
            this.$message({
          ...
          api.workshopOrderDeplane.addSize({
            name: this.editValue,
            workshopOrderId: this.workshopOrderId
          }).then(() => {
            this.$message({
      ...
      saveRowEdit() {
        if (this.editId) {
          api.workshopOrderDeplane.updateName({
            name: this.editValue,
            id: this.editId
          }).then(() => {
            this.$message({
          ...
          api.workshopOrderDeplane.addName({
            name: this.editValue,
            workshopOrderId: this.workshopOrderId
          }).then(() => {
            this.$message({
      ...
      deleteColumn(size) {
        this.$confirm(`是否删除尺寸: ${size.value}(整列)？`, '提示', {
          ...
          api.workshopOrderDeplane.deleteSize({
            sizeId: size.id,
      ...
      deleteRow(name) {
        this.$confirm(`是否删除名称: ${name.value}(整行)？`, '提示', {
          ...
          api.workshopOrderDeplane.deleteName({
            nameId: name.id,
            orderId: this.workshopOrderId
          }).then(() => {
            this.$message({
