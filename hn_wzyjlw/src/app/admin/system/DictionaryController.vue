<template>
  <eui-layout :regions="REGIONS">
      ...
      <eui-table
        ...
        <el-table-column label="用途" align="center" width="100">
          <template slot-scope="scope">
            {{getPurposeCN(scope.row.purpose)}}
          </template>
        </el-table-column>
    ...
    <eui-window ref="window"
      ...
      <el-form class="clearfix" ref="form" :model="formdata" label-width="50px" :rules="rules" style="padding: 20px">
    ...
    <eui-window ref="subwindow"
      ...
      <el-form class="clearfix" ref="subform" :model="subformdata" label-width="50px" :rules="rules"
               style="padding: 20px">
        <el-col :sm="24" v-for="(item, index) in FORMDATA" :key="index">
          <el-form-item v-if="item.value !== 'purpose'" :label="item.name" :prop="item.value">
