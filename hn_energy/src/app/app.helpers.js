...
export default {
  ...
  getSubTableButtons (buttons, subButtons) {
    return buttons.filter(btn => subButtons.includes(btn.btnKey))
  },
  ...
  getImgUrl: (url) => {
    return url ? config.serverURI + system.prev + url : ''
  },
  getFlieList: (list) => {
