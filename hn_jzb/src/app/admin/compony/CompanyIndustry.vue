  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          name: [{
            required: true, message: '请输入行业名称', trigger: ['blur', 'change']
          }]
        },
        query: {
          name: null,
    ...
    methods: {
      getData(query) {
        api.companyIndustry.getCompanyIndustryPaged(query).then(data => {
        ...
        let btnHandlers = {
          ...
          btnDelete: (arg) => {
            ...
            this.$confirm(`是否删除:${this.formdata.name}？`, '提示', {
              ...
              api.companyIndustry.deleteCompanyIndustry(this.formdata.id).then(() => {
                this.$message({
                  message: '删除成功!',
                  type: 'success'
                })
      ...
      sure() {
        this.$refs.form.validate((valid) => {
          if (valid) {
            if (!this.formdata.id) {
              api.companyIndustry.addCompanyIndustry(this.formdata).then(() => {
                this.$message({
                  message: '新增成功!',
                  type: 'success'
                })
              ...
              api.companyIndustry.updateCompanyIndustry(this.formdata).then(() => {
                this.$message({
                  message: '编辑成功!',
                  type: 'success'
                })
