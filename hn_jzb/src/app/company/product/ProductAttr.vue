...
<script>
  ...
  export default {
    name: 'company-product-attr',
    _meta: {
      path: '/company/product/attr',
      title: '产品属性'
    },
    mixins: [TabPane],
    components: {
    ...
    methods: {
      getData(query) {
        api.companyProductCategoryAttr.getAttrPaged(query).then(data => {
        ...
        let btnHandlers = {
          ...
          btnDelete: (row) => {
            ...
            this.$confirm(`是否删除:${this.formdata.name}？`, '提示', {
              ...
              api.companyProductCategoryAttr.deleteAttr(this.formdata.id).then(() => {
                this.$message({
                  message: '删除成功!',
                  type: 'success'
                })
      ...
      sure() {
        this.$refs.form.validate((valid) => {
          ...
          if (valid) {
            ...
            if (!this.formdata.id) {
              api.companyProductCategoryAttr.addAttr(params).then(() => {
                this.$message({
                  message: '新增成功!',
                  type: 'success'
                })
              ...
              api.companyProductCategoryAttr.updateAttr(params).then(() => {
                this.$message({
                  message: '编辑成功!',
                  type: 'success'
                })
