...
<script>
  import api from '@/api'
  import {ONOFF} from './agv.config'
  import helper from '@/app/app.helpers'
  import EuiLayout from '@/components/common/layout/EuiLayout'
  import EuiTable from '@/components/common/form/EuiTable'
  import EuiInput from '@/components/common/form/EuiInput'
  export default {
    name: 'agv-on-off-detect',
    _meta: {
      path: '/agv/onoffdetect',
      title: 'AGV上下线管理'
    },
    components: {
      EuiLayout,
    ...
    data() {
      return {
        ...
        tableOptions: {
          ...
          total: 0,
          columns: [
            {prop: 'agvNo', label: 'AGV编号', minWidth: 150},
    ...
    methods: {
      getData() {
        api.agvOnoff.paged(this.query).then(data => {
