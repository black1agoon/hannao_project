<template>
  <el-popover
    ...
    <el-form class="form clearfix" ref="form">
      <el-col :sm="6" v-for="(data, index) in defaultOptions.fieldSearch" :key="index">
        <eui-input size="mini"
    ...
    <el-form class="form clearfix" ref="form">
      <el-col :sm="6" v-for="(data, index) in defaultOptions.conditionSearch" :key="index">
        <eui-input size="mini"
                   v-model="searchinfo[data.value]"
                   :type="data.type"
                   :placeholder="data.placeholder"
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        helper,
        defaultOptions: Object.assign({}, this.options),
        searchinfo: {},
        tags: (() => {
